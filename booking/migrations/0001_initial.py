    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nbPlaceAvailable', models.IntegerField(default=models.IntegerField())),
                ('prix', models.FloatField()),
                ('statut', models.CharField(choices=[('draft', 'Brouillon'), ('archived', 'Archivé'), ('published', 'Publié')], default='draft', max_length=20)),
